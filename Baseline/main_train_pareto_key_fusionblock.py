...
import numpy as np
import random
from modules.pareto_trainer_key_fusionblock import KeyFusionBlockEveryStepParetoTrainer
import wandb
...
if __name__ == '__main__':
    ...
    if args.train_mode == "TVT":
        trainer = KeyFusionBlockEveryStepParetoTrainer(fold=0, args=args)
        ...
        for fold in cv_list:
            trainer = KeyFusionBlockEveryStepParetoTrainer(fold=fold, args=args)

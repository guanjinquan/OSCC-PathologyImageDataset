...
import numpy as np
import random
from modules.pareto_trainer_every_step import EveryStepParetoTrainer
import wandb
...
if __name__ == '__main__':
    ...
    if args.train_mode == "TVT":
        trainer = EveryStepParetoTrainer(fold=0, args=args)
        ...
        for fold in cv_list:
            trainer = EveryStepParetoTrainer(fold=fold, args=args)
